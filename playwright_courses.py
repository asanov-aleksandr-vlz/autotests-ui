...
with sync_playwright() as playwright:
    ...
    there_is_no_results_alert = page.get_by_test_id("courses-list-empty-view-title-text")
    ...
    results_from_the_load_test_pipeline_will_be_displayed_here_alert = page.get_by_test_id(
